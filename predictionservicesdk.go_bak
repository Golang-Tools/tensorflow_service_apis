...
func (c *PredictionServiceSDK) initStandalone() error {
	c.addr = c.Address[0]
	return nil
}

//InitWithLocalBalance 初始化本地负载均衡的连接配置
func (c *PredictionServiceSDK) initWithLocalBalance() error {
	serverName := ""
	if c.AppName != "" {
		if c.AppVersion != "" {
...
func (c *PredictionServiceSDK) initWithZooKeeperBalance() error {
...
//NewConn 建立一个新的连接
func (c *PredictionServiceSDK) NewConn() (*PredictionServiceConn, error) {
...
type PredictionServiceConn struct {
	...
	sdk  *PredictionServiceSDK
	once bool
}

func newPredictionServiceConn(sdk *PredictionServiceSDK, addr string, opts ...grpc.DialOption) (*PredictionServiceConn, error) {
