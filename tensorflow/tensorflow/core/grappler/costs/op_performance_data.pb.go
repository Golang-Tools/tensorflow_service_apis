...
func (x *OpInfo_TensorProperties) GetDtype() framework.DataType {
	if x != nil {
		return x.Dtype
	}
...
func (x *OpInfo_TensorProperties) GetShape() *framework.TensorShapeProto {
	if x != nil {
		return x.Shape
	}
	return nil
...
func (x *OpInfo_TensorProperties) GetValue() *framework.TensorProto {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_tensorflow_core_grappler_costs_op_performance_data_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x50, 0x65, 0x72, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x42, 0x29, 0x5a,
	0x24, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x74, 0x65, 0x6e, 0x73,
	0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x67, 0x72, 0x61, 0x70, 0x70, 0x6c, 0x65, 0x72, 0x2f,
	0x63, 0x6f, 0x73, 0x74, 0x73, 0xf8, 0x01, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_tensorflow_core_grappler_costs_op_performance_data_proto_goTypes = []interface{}{
	...
	(*protobuf.DeviceProperties)(nil),  // 9: tensorflow.DeviceProperties
	(*framework.AttrValue)(nil),        // 10: tensorflow.AttrValue
	(framework.DataType)(0),            // 11: tensorflow.DataType
	(*framework.TensorShapeProto)(nil), // 12: tensorflow.TensorShapeProto
	(*framework.TensorProto)(nil),      // 13: tensorflow.TensorProto
}
